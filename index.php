  ...
  <div class="list closed"> 
   <ul>
    ...
    <li class="title"><i class="iconfont icon-msg"></i> 论坛</li> 
       <li><a rel="nofollow" href="https://blog.star-search.cn/" target="_blank"><i class="iconfont icon-gmail" style="color: #f03;"></i>星芒博客</a></li>
        <li><a rel="nofollow" href="https://www.weibo.com" target="_blank"><i class="iconfont icon-weibo" style="color: #e6162d;"></i>微博</a></li> 
    ...
    <li class="title"><i class="iconfont icon-ai-tool"></i> 工具</li> 
        <li><a rel="nofollow" href="https://pan.star-search.cn/" target="_blank"><i class="iconfont icon-cloud-download" style="color: #ff6019;"></i>星芒下载站</a></li>
        <li><a rel="nofollow" href="https://tool.star-search.cn/" target="_blank"><i class="iconfont icon-wangluo1" style="color: #ff6019;"></i>星芒工具箱</a></li>
        <li><a rel="nofollow" href="https://yiyan.baidu.com/" target="_blank"><i class="iconfont icon-baidu" style="color: #ff6019;"></i>文心一言</a></li> 
  ...
  <div id="search" class="s-search">
   <div id="search-list" class="hide-type-list">
    ...
    <div class="search-group group-c">
     ...
     <li><input onclick="bw()" hidden="" type="radio" name="type" id="type-github" value="https://github.com/search?q=" data-placeholder="请输入想在Github搜索的项目" /><label for="type-github"><span>Github</span></label></li>
